...
public class cxyDecoder extends LengthFieldBasedFrameDecoder {
    cxyDecoder(int maxlength, int offset, int length) {
    ...
    protected Object decode(ChannelHandlerContext ctx, ByteBuf in) throws Exception {
        ...
        System.out.println("server decode msg"+msg.getFromUid()+" "+msg.getToUid()+" "+msg.getLength()+" "+msgBody);
        return msg;
    }
}
